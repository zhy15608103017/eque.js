...
//    console.log(this.props);
    return (
      <div>
        <button onClick={this.setLocation} style={{
            ...styles,
...
class ReactReader extends PureComponent {
  ...
  renderToc() {
    ...
    const { readerStyles, location } = this.props
          ...
          <div style={readerStyles.toc}>
            {toc.map((item, i) => (
              <TocItem
                ...
                styles={
                  item.href === this.state.id
                    ? { ...readerStyles.tocAreaButton, color: '#3b0eec' }
                    : readerStyles.tocAreaButton
                }
              />
            ))}
          </div>
      ...
      <div style={readerStyles.container}>
        ...
        >
          ...
          >
            <div
              style={
                expandedToc ? { ...readerStyles.reader } : readerStyles.reader
              }
            >
              {barRander()}
              <EpubView
